          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="mb-5">
                ...
                {/* Salary box — width aligned with left column (sidebar = lg:w-72 + gap-5) */}
                <div className="p-3 rounded-xl bg-accent/10 border border-accent/20 mb-4 lg:max-w-[calc(100%-19rem)]">
